...
with models.DAG(
    ...
    kubernetes_list_bucket_pod = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        task_id='curation-component',
        # Name of task you want to run, used to generate Pod ID.    
        name='curation-component',
        ...
        namespace='composer-1-10-3-airflow-1-10-6-6d775433',
        startup_timeout_seconds=300,
        secrets=[secret_file],
        image='us.gcr.io/ekstepspeechrecognition/preprocess:1.0.0',
